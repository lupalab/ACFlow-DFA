...
from dfa_modules.mb_learn import MB
from dfa_modules.bn_learn import GS
...
save_dir = os.path.join(params.exp_dir, 'bn_learn')
os.makedirs(save_dir, exist_ok=True)
logging.basicConfig(filename=save_dir + '/bn_learn.log',
                    filemode='w',
                    level=logging.INFO,
                    format='%(message)s')
...
# MB
mb_func = MB(params, model)

# GS
gs_func = GS(params, model)
